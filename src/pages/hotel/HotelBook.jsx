    ...
    <div className="lg:p-24 p-6">
      <form className="w-full pt-2 flex flex-col lg:flex-row justify-between">
        <div className="p-8">
          ...
          <br></br>
          <h1 className="font-semibold text-[#565656] lg:text-lg">
            Card Number
          </h1>
          <p className="text-[#929292] text-sm pt-2">
          ...
          <p className="text-[#929292] text-sm pt-2">
            Enter the 3 or 4 digit number on the back side of the card
          </p>
          <input
            type="text"
            placeholder="241"
          ...
          <h1 className="font-semibold text-[#565656] lg:text-lg pt-6">
            Expiry Dare
          </h1>
          <p className="text-[#929292] text-sm pt-2">
            Enter the expire date of the card
          </p>
        ...
        <div className="flex flex-col justify-center items-center">
          ...
          <button className="bg-[#41A4FF] rounded-lg text-white p-2 w-full">
            Confirm and Pay Now
          </button>
