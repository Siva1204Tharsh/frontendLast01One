    ...
    <div class=" p-10 items-center justify-start bg-[#F5F5F5]">
      <div class="mx-auto w-full max-w-lg  ">
        ...
        <form action="https://api.web3forms.com/submit" class="mt-10">
          ...
          <div class="grid gap-6 sm:grid-cols-2">
            <div class="relative z-0">
              <input
                ...
                placeholder=" "
              />
              <label class="absolute top-3 -z-10 origin-[0] -translate-y-6 scale-75 transform text-sm text-gray-500 duration-300 peer-placeholder-shown:translate-y-0 peer-placeholder-shown:scale-100 peer-focus:left-0 peer-focus:-translate-y-6 peer-focus:scale-75 peer-focus:text-[#008080] peer-focus:dark:text-blue-500">
                Your name
              </label>
            </div>
            <div class="relative z-0">
          ...
          <button
            type="submit"
            class="mt-5 rounded-md bg-[#008080] px-10 py-2 text-white"
          >
            Send Message
          </button>
        </form>
